    ...
    if not flag:
        ...
        for num in range(len(person)):
            if prices[num] > price_average:
                print(f"{person[num]} spent {prices[num]} on food. That is more than the average cost on food!")
            elif prices[num] < price_average:
                print(f"{person[num]} spent {prices[num]} on food. That is less than the average cost on food!")
            elif prices[num] == price_average:
                print(f"{person[num]} spent {prices[num]} on food. That is the average cost on food!")
        print()

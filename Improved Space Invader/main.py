...
def setting_selection(option, val_list):
    ...
    while True:
        ...
        screen.blit(pygame.font.Font("freesansbold.ttf", 22).render("ENTER To Go Back", True, (255, 255, 255)),
                    (10, 565))
...
def settings_screen():
    ...
    while True:
        ...
        screen.blit(pygame.font.Font("freesansbold.ttf", 22).render("ENTER To Select", True,
                                                                    (255, 255, 255)), (10, 565))
